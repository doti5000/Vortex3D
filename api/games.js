  ...
  const defaultGames = [
    {
      ...
      thumbnail_url: '',
      tunnel_url: 'https://zen-jim-webpage-bradley.trycloudflare.com?room=arena1',
      plays: 1420,
      likes: 89,
      created_at: new Date().toISOString()
    },
    {
      ...
      thumbnail_url: '',
      tunnel_url: 'https://zen-jim-webpage-bradley.trycloudflare.com?room=sandbox1',
      plays: 980,
      likes: 64,
      created_at: new Date().toISOString()
    },
    {
      ...
      thumbnail_url: '',
      tunnel_url: 'https://zen-jim-webpage-bradley.trycloudflare.com?room=highway1',
      plays: 750,
      likes: 42,
      created_at: new Date().toISOString()
    }
